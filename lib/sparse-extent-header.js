...
/**
 * SparseExtentHeader flags
 * @enum {Number}
 */
SparseExtentHeader.FLAGS = {
  /** @type {Number} Valid new line detection test */
  VALID_EOL_TEST: 1 << 0,
  /** @type {Number} Redundant grain table will be used */
  USE_REDUNDANT_GT: 1 << 1,
  /** @type {Number} Zeroed-grain GTE will be used */
  ZERO_GRAIN_GTE: 1 << 2,
  /** @type {Number} The grains are compressed, for alg check `compressAlgorithm` */
  COMPRESSED_GRAINS: 1 << 16,
  /** @type {Number} Markers in disk to identify blocks of metadata and data, and markers contain LBAs */
  BLOCK_MARKERS: 1 << 16,
}
